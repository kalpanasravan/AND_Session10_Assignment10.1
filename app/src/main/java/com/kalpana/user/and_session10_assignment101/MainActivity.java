package com.kalpana.user.and_session10_assignment101;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn= (Button)findViewById(R.id.butClick);
    ...
    private void showDialog(){
        ...
        alert.getWindow().setBackgroundDrawable(new ColorDrawable(Color.MAGENTA));
